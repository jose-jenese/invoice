...
$dbname = "srt"; // Replace with your actual database name
...
$countQuery = "SELECT COUNT(*) AS invoice_count FROM invoices"; 
$countQuery1 = "SELECT COUNT(*) AS user_count FROM user"; 
...
$lastWeekQuery = "SELECT COUNT(*) AS last_week_users FROM user WHERE date_created >= NOW() - INTERVAL 7 DAY";
$lastWeekQuery1 = "SELECT COUNT(*) AS last_week_invoices FROM invoices WHERE created_at >= NOW() - INTERVAL 7 DAY";
$lastWeekResult = $conn->query($lastWeekQuery);
$lastWeekResult1 = $conn->query($lastWeekQuery1);

if ($lastWeekResult) {
    $lastWeekRow = $lastWeekResult->fetch_assoc();
    $lastWeekUsers = $lastWeekRow['last_week_users'];
} else {
    $lastWeekUsers = 0;
}

if ($lastWeekResult1) {
    $lastWeekRow1 = $lastWeekResult1->fetch_assoc();
    $lastWeekInvoices = $lastWeekRow1['last_week_invoices'];
} else {
    $lastWeekInvoices = 0;
}
?>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                        ...
                        <div class="col-lg-3">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Number Of Invoice</h4>
                                        <p><?= $invoiceCount ?></p>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h2></h2>
                        ...
                        <div class="col-lg-3">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><i class="fa-solid fa-users"></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Last Week Users</h4>
                                        <p><?= $lastWeekUsers ?></p>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h2></h2>
                        ...
                        <div class="col-lg-3">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><i class="fa-solid fa-file-invoice"></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Last Week Invoice</h4>
                                        <p><?= $lastWeekInvoices ?></p>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h2></h2>
                                        <!-- <span>-45.87</span> -->
                ...
                <div class="row" style="margin-bottom:30px;">   
                    <div class="col-md-3"><a href="add_user.php">
  <button style="border-radius: 7px; background: linear-gradient(to right, #4e54c8, #8f94fb); padding: 10px 20px;"> + Add New User</button>
</a></div>
                    <div class="col-md-3"><a href="add_invoice.php">
  <button style="border-radius: 7px; background: linear-gradient(to right, #4e54c8, #8f94fb); padding: 10px 20px;"> + Create Invoice</button>
</a></div>
